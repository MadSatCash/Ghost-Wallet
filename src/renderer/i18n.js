const TRANSLATIONS = {
  es: {
    ...
    version_badge: 'v0.11.3 · Privacidad Total',
    ...
    spv_waiting_header: 'esperando cabecera',
    ...
    history_mined_at: 'minada el {datetime}',
  ...
  en: {
    ...
    version_badge: 'v0.11.3 · Total Privacy',
    ...
    spv_waiting_header: 'awaiting header',
    spv_failed: '⚠ mismatch',
    ...
    history_mined_at: 'mined {datetime}',
