const TRANSLATIONS = {
  es: {
    ...
    version_badge: 'v0.9.3 · Privacidad Total',
    ...
    type_hex: 'Clave cruda de 64 chars (256 bits)',
    ...
    hex_hint: 'Genera un secreto aleatorio de 64 caracteres hexadecimales (256 bits de entropía), equivalente a <code>secrets.token_hex(32)</code> en Python.',
    ...
    type_hex_detail: 'Tipo: Clave cruda de 64 (256 bits)',
    ...
    wallet_tag_hd: 'HD · multiples direcciones',
    loading_bch: '... BCH',
    error_text: 'Error',
  ...
  en: {
    ...
    version_badge: 'v0.9.3 · Total Privacy',
    ...
    type_hex: '64-char raw key (256 bits)',
    ...
    hex_hint: 'Generates a random 64-character hex secret (256 bits of entropy), equivalent to <code>secrets.token_hex(32)</code> in Python.',
    ...
    type_hex_detail: 'Type: 64-char raw key (256 bits)',
